...
import static org.junit.Assert.assertTrue;
    ...
    public class FaqAccordionTest {
        ...
        //конструктор
        public FaqAccordionTest(int index, String expectedText) {

        // индекс: от 0 до 7 (он одинаковый в вопросах и ответах, поэтому берем один для всех)
            this.index = index;
            this.expectedText = expectedText;
        }

        @Parameterized.Parameters(name = "Вопрос {0}: проверка текста ответа")
        // тестовые данные
        public static Collection<Object[]> getFaqTest() {
...
// метод для старта драйвера хром
    ...
    public void checkAccordion() {
        ...
        // проверяем соответствие текста
            String actualText = homePage.getAccordionAnswerText(index, expectedText);
